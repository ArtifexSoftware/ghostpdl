...
# We now build with unicode by default. To avoid this, build with
# GS_NO_UTF8=1
!if "$(GS_NO_UTF8)" != ""
...
# We assume SSE2 extensions here. To avoid this use make HAVE_SSE2_DEFINE=""
!ifndef HAVE_SSE2_DEFINE
