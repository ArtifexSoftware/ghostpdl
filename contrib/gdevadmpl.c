...
/* Standard DMP device */
const gx_device_printer far_data gs_appledmpl_device =
prn_device(gdev_prn_initialize_device_procs_mono_bg, "appledmpl",	/* The print_page proc is compatible with allowing bg printing */
        85,				/* width_10ths, 8.5" */
        110,				/* height_10ths, 11" */
        120, 72,			/* X_DPI, Y_DPI */
        0, 0.5, 0.5, 0,		/* margins */
...
const gx_device_printer far_data gs_iwlol_device =
prn_device(gdev_prn_initialize_device_procs_mono_bg, "iwlol",	/* The print_page proc is compatible with allowing bg printing */
        85,				/* width_10ths, 8.5" */
        110,				/* height_10ths, 11" */
        160, 72,			/* X_DPI, Y_DPI */
        0, 0.5, 0.5, 0,		/* margins */
...
const gx_device_printer far_data gs_iwhil_device =
prn_device(gdev_prn_initialize_device_procs_mono_bg, "iwhil",	/* The print_page proc is compatible with allowing bg printing */
        85,				/* width_10ths, 8.5" */
        110,				/* height_10ths, 11" */
        160, 144,			/* X_DPI, Y_DPI */
        0, 0.5, 0.5, 0,		/* margins */
...
const gx_device_printer far_data gs_iwlql_device =
prn_device(gdev_prn_initialize_device_procs_mono_bg, "iwlql",	/* The print_page proc is compatible with allowing bg printing */
        85,				/* width_10ths, 8.5" */
        110,				/* height_10ths, 11" */
        320, 216,
        0, 0, 0.5, 0,		/* margins */
