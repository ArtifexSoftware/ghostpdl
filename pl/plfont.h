...
struct pl_font_s {
  ...
  int (*char_width)(const pl_font_t *plfont, const void *pgs, gs_char char_code, gs_point *pwidth);
  int (*char_metrics)(const pl_font_t *plfont, const void *pgs, gs_char char_code, float metrics[4]);
