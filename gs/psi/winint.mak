...
gs$(GS_VERSION)src.zip:
	...
	-del temp.zip
	zip -r -X temp.zip LICENSE doc examples ijs jasper jbig2dec jpeg lib libpng base psi Resource tiff zlib freetype lcms cups -x ".svn/*" -x "*/.svn/*" -x "*/*/.svn/*" -x "*/*/*/.svn/*" -x "*/*/*/*/.svn/*" -x "*/*/*/*/*/.svn/*"
