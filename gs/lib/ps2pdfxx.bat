...
call %~dp0gssetgs.bat
echo -q -P- -dSAFER -dNOPAUSE -dBATCH -sDEVICE#pdfwrite >%TEMP%_.at2
...
:run
echo -sOutputFile#%2 >>%TEMP%_.at2
copy /b /y %TEMP%_.at2+%TEMP%_.at %TEMP%_.at2 >NUL
echo -c .setpdfwrite -f%1 >>%TEMP%_.at2
%GSC% @%TEMP%_.at @%TEMP%_.at2
goto end
...
if exist %TEMP%_.at2 erase %TEMP%_.at2
