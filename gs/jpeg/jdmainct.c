			   ...
			   JDIMENSION out_rows_avail)
{
  ...
  case CTX_PREPARE_FOR_IMCU:
    ...
    pmain->rowgroup_ctr = 0;
    pmain->rowgroups_avail = (JDIMENSION) (cinfo->min_DCT_v_scaled_size - 1);
  ...
  case CTX_PROCESS_IMCU:
    ...
    pmain->rowgroup_ctr = (JDIMENSION) (cinfo->min_DCT_v_scaled_size + 1);
    pmain->rowgroups_avail = (JDIMENSION) (cinfo->min_DCT_v_scaled_size + 2);
