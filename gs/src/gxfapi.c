...
private LPUB8 stub_PCLchId2ptr(UW16 chId)
{   return NULL;
}

private LPUB8 stub_PCLglyphID2Ptr(UW16 glyphID)
{   return NULL;
}
...
/*
    ...
    Also we are waiting for Agfa to fix the reentrancy of UFST callbacks -
    need an additional argument for all them.
 */

private LPUB8 (*m_PCLEO_charptr)(P2(LPUB8 pfont_hdr, UW16  sym_code)) = stub_PCLEO_charptr;
private LPUB8 (*m_PCLchId2ptr)(P1(UW16 chId)) = stub_PCLchId2ptr;
private LPUB8 (*m_PCLglyphID2Ptr)(P1(UW16 glyphID)) = stub_PCLglyphID2Ptr;
...
LPUB8 PCLchId2ptr(UW16 chId)
{   return m_PCLchId2ptr(chId);
}

LPUB8 PCLglyphID2Ptr(UW16 glyphID)
{   return m_PCLglyphID2Ptr(glyphID);
}
