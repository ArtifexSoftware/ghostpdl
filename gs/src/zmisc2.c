...
set_language_level(int level)
{
    ...
    if (level == 2) {		/* from Level 1 to Level 2 *//* Put globaldict in the dictionary stack. */
	ref *pdict;
    ...
    } else {			/* from Level 2 to Level 1 *//* Clear the cached definition pointers of all names */
