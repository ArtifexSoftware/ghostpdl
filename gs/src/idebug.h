...
void debug_dump_refs(const gs_memory_t *mem, const ref * from, uint size, const char *msg);
...
#endif
void debug_dump_stack(const gs_memory_t *mem, const ref_stack_t * pstack, const char *msg);
