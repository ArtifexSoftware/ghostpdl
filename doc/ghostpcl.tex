...
GhostPCL family of products:  \emph{PCL5E}~\cite{PCLTRM},
\emph{PCL5C}~\cite{PCL5CTRM}, \emph{PCLXL}~\cite{PCLXLTRM}, and
\emph{HPGL/2} with \emph{RTL}~\cite{RTLTRM}, additionally a scaled
down \emph{PJL}~\cite{PJLTRM} interpreter is provided.  All of the PCL
products use the Ghostscript Graphic Library for graphics, imaging and
driver support.  A brief tour of the Ghostscript documentation
\url{www.ghostscript.com/doc/} will be helpful to understand this
document.  The relevant ghostscript version used by PCL can be found
in gs/src/version.mak.
...
documentation \url{www.ghostscript.com/doc/}, hav similar effect in
