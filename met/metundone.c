...
UNDONE_STUB(CombinedGeometry);
UNDONE_STUB(CombinedGeometry_Geometry1);
UNDONE_STUB(CombinedGeometry_Geometry2);
UNDONE_STUB(CombinedGeometry_Transform);
...
UNDONE_STUB(GeometryGroup);
UNDONE_STUB(GeometryGroup_Transform);
