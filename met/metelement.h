...
EXTERN(CombinedGeometry);
EXTERN(CombinedGeometry_Geometry1);
EXTERN(CombinedGeometry_Geometry2);
EXTERN(CombinedGeometry_Transform);
...
EXTERN(GeometryGroup);
EXTERN(GeometryGroup_Transform);
EXTERN(Glyphs);
EXTERN(Glyphs_Clip);
EXTERN(Glyphs_Fill);
