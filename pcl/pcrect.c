...
{		/* Register commands */
	DEFINE_CLASS('*')
	  {'c', 'H', {pcl_horiz_rect_size_decipoints, pca_neg_error|pca_big_error}},
	  {'c', 'A', {pcl_horiz_rect_size_units, pca_neg_error|pca_big_error}},
	  {'c', 'V', {pcl_vert_rect_size_decipoints, pca_neg_error|pca_big_error}},
	  {'c', 'B', {pcl_vert_rect_size_units, pca_neg_error|pca_big_error}},
	  {'c', 'P', {pcl_fill_rect_area, pca_neg_ignore|pca_big_ignore}},
	END_CLASS
	return 0;
}
private void
