...
const font_resident_t pl_built_in_resident_font_table[] = {
...
#define EXBOLD          (4)
    ...
    {
        { "Courier", "CourierMT", "NimbusMono-Regular" },
        {'C', 'o', 'u', 'r', 'i', 'e', 'r', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
         ' ', ' '},
    ...
    {
        { "CGTimes", "CGTimes", "NimbusRomanNo4-Regular" },
        {'C', 'G', ' ', 'T', 'i', 'm', 'e', 's', ' ', ' ', ' ', ' ', ' ', ' ',
         ' ', ' '},
    ...
    {
        { "CGTimesBold", "CGTimes-Bold", "NimbusRomanNo4-Bold" },
        {'C', 'G', ' ', 'T', 'i', 'm', 'e', 's', ' ', ' ', ' ', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "CGTimesItalic", "CGTimes-Italic", "NimbusRomanNo4-Italic" },
        {'C', 'G', ' ', 'T', 'i', 'm', 'e', 's', ' ', ' ', ' ', ' ', ' ', ' ',
         'I', 't'},
    ...
    {
        { "CGOmega", "CGOmega", "URWClassico-Regular" },
        {'C', 'G', ' ', 'O', 'm', 'e', 'g', 'a', ' ', ' ', ' ', ' ', ' ', ' ',
         ' ', ' '},
    ...
    {
        { "CGOmegaBold", "CGOmega-Bold", "URWClassico-Bold" },
        {'C', 'G', ' ', 'O', 'm', 'e', 'g', 'a', ' ', ' ', ' ', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "CGOmegaItalic", "CGOmega-Italic", "URWClassico-Italic" },
        {'C', 'G', ' ', 'O', 'm', 'e', 'g', 'a', ' ', ' ', ' ', ' ', ' ', ' ',
         'I', 't'},
    ...
    {
        { "CGOmegaBoldItalic", "CGOmega-BoldItalic",
    ...
    {
        { "UniversMedium", "Univers-Medium", "URWClassicSans-Regular" },
        {'U', 'n', 'i', 'v', 'e', 'r', 's', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
         'M', 'd'},
    ...
    {
        { "UniversBold", "Univers-Bold", "URWClassicSans-Bold" },
        {'U', 'n', 'i', 'v', 'e', 'r', 's', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "UniversMediumItalic", "Univers-MediumItalic", "URWClassicSans-RegularItalic" },
        {'U', 'n', 'i', 'v', 'e', 'r', 's', ' ', ' ', ' ', ' ', ' ', 'M', 'd',
         'I', 't'},
    ...
    {
        { "UniversBoldItalic", "Univers-BoldItalic", "URWClassicSans-BoldItalic" },
        {'U', 'n', 'i', 'v', 'e', 'r', 's', ' ', ' ', ' ', ' ', ' ', 'B', 'd',
         'I', 't'},
    ...
    {
        { "AntiqueOlive", "AntiqueOlive", "AntiqueOlive-Regular" },
        {'A', 'n', 't', 'i', 'q', 'O', 'l', 'i', 'v', 'e', ' ', ' ', ' ', ' ',
         ' ', ' '},
    ...
    {
        { "AntiqueOliveBold", "AntiqueOlive-Bold", "AntiqueOlive-Bold" },
        {'A', 'n', 't', 'i', 'q', 'O', 'l', 'i', 'v', 'e', ' ', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "GaramondAntiqua", "Garamond-Antiqua", "Garamond-Antiqua" },
    ...
    {
        { "GaramondHalbfett", "Garamond-Halbfett", "Garamond-Halbfett" },
        {'G', 'a', 'r', 'a', 'm', 'o', 'n', 'd', ' ', ' ', ' ', ' ', ' ', 'H',
         'l', 'b'},
    ...
    {
        { "GaramondKursiv", "Garamond-Kursiv", "Garamond-Kursiv" },
        {'G', 'a', 'r', 'a', 'm', 'o', 'n', 'd', ' ', ' ', ' ', ' ', 'K', 'r',
         's', 'v'},
    ...
    {
        { "Marigold", "Marigold", "Mauritius-Regular" },
        {'M', 'a', 'r', 'i', 'g', 'o', 'l', 'd', ' ', ' ', ' ', ' ', ' ', ' ',
         ' ', ' '},
    ...
    {
        { "AlbertusMedium", "Albertus-Medium", "Algiers-Medium" },
        {'A', 'l', 'b', 'e', 'r', 't', 'u', 's', ' ', ' ', ' ', ' ', ' ', ' ',
         'M', 'd'},
    ...
    {
        { "AlbertusExtraBold", "Albertus-ExtraBold", "Algiers-ExtraBold" },
        {'A', 'l', 'b', 'e', 'r', 't', 'u', 's', ' ', ' ', ' ', ' ', ' ', ' ',
         'X', 'b'},
    ...
    {
        { "Arial", "Arial", "NimbusSansNo2-Regular" },
        {'A', 'r', 'i', 'a', 'l', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
         ' ', ' '},
    ...
    {
        { "Arial-BoldMT", "Arial-Bold", "NimbusSansNo2-Bold" },
        {'A', 'r', 'i', 'a', 'l', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "Arial-ItalicMT", "Arial-Italic", "NimbusSansNo2-Italic" },
        {'A', 'r', 'i', 'a', 'l', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
         'I', 't'},
    ...
    {
        { "Arial-BoldItalicMT", "Arial-BoldItalic", "NimbusSansNo2-BoldItalic" },
        {'A', 'r', 'i', 'a', 'l', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'B', 'd',
         'I', 't'},
    ...
    {
        { "TimesNewRoman", "TimesNewRoman", "NimbusRomanNo9-Regular" },
    ...
    {
        { "TimesNewRoman-Bold", "TimesNewRoman-Bold",
                  "NimbusRomanNo9-Bold" },
        {'T', 'i', 'm', 'e', 's', 'N', 'e', 'w', 'R', 'm', 'n', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "Helvetica", "Helvetica", "NimbusSans-Regular" },
        {'H', 'e', 'l', 'v', 'e', 't', 'i', 'c', 'a', ' ', ' ', ' ', ' ', ' ',
         ' ', ' '},
    ...
    {
        { "Helvetica-Bold", "Helvetica-Bold", "NimbusSans-Bold" },
        {'H', 'e', 'l', 'v', 'e', 't', 'i', 'c', 'a', ' ', ' ', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "Helvetica-Narrow", "Helvetica-Narrow", "NimbusSansNarrow-Regular" },
        {'H', 'e', 'l', 'v', 'e', 't', 'i', 'c', 'a', ' ', ' ', ' ', ' ', ' ',
         'N', 'r'},
    ...
    {
        { "Palatino-Roman", "Palatino-Roman", "P052-Roman" },
        {'P', 'a', 'l', 'a', 't', 'i', 'n', 'o', ' ', ' ', ' ', ' ', ' ', 'R',
         'm', 'n'},
    ...
    {
        { "Palatino-Italic", "Palatino-Italic", "P052-Italic" },
        {'P', 'a', 'l', 'a', 't', 'i', 'n', 'o', ' ', ' ', ' ', ' ', ' ', ' ',
         'I', 't'},
    ...
    {
        { "Palatino-Bold", "Palatino-Bold", "P052-Bold" },
        {'P', 'a', 'l', 'a', 't', 'i', 'n', 'o', ' ', ' ', ' ', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "AvantGarde-Book", "AvantGarde-Book", "URWGothic-Book" },
    ...
    {
        { "AvantGarde-Demi", "AvantGarde-Demi", "URWGothic-Demi" },
        {'I', 'T', 'C', 'A', 'v', 'a', 'n', 't', 'G', 'a', 'r', 'd', ' ', ' ',
         'D', 'b'},
    ...
    {
        { "Bookman-Light", "Bookman-Light", "URWBookman-Light" },
        {'I', 'T', 'C', 'B', 'o', 'o', 'k', 'm', 'a', 'n', ' ', ' ', ' ', ' ',
         'L', 't'},
    ...
    {
        { "Bookman-Demi", "Bookman-Demi", "URWBookman-Demi" },
        {'I', 'T', 'C', 'B', 'o', 'o', 'k', 'm', 'a', 'n', ' ', ' ', ' ', ' ',
         'D', 'b'},
    ...
    {
        { "Times-Roman", "Times-Roman", "NimbusRoman-Regular" },
        {'T', 'i', 'm', 'e', 's', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'R',
         'm', 'n'},
    ...
    {
        { "Times-Bold", "Times-Bold", "NimbusRoman-Bold" },
        {'T', 'i', 'm', 'e', 's', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "Times-Italic", "Times-Italic", "NimbusRoman-Italic" },
        {'T', 'i', 'm', 'e', 's', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
         'I', 't'},
    ...
    {
        { "SymbPS", "SymbPS", "StandardSymbolsPS" },
        {'S', 'y', 'm', 'b', 'o', 'l', 'P', 'S', ' ', ' ', ' ', ' ', ' ', ' ',
         ' ', ' '},
    ...
    {
        { "Wingdings-Regular", "Wingdings-Regular", "URWDings" },
        {'W', 'i', 'n', 'g', 'd', 'i', 'n', 'g', 's', ' ', ' ', ' ', ' ', ' ',
         ' ', ' '},
    ...
    {
        { "CourierBold", "CourierMT-Bold", "NimbusMono-Bold" },
        {'C', 'o', 'u', 'r', 'i', 'e', 'r', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "CourierItalic", "CourierMT-Italic", "NimbusMono-Italic" },
        {'C', 'o', 'u', 'r', 'i', 'e', 'r', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
         'I', 't'},
    ...
    {
        { "CourierBoldItalic", "CourierMT-BoldItalic",
    ...
    {
        { "LetterGothic", "LetterGothic", "LetterGothic-Regular" },
    ...
    {
        { "LetterGothicBold", "LetterGothic-Bold", "LetterGothic-Bold" },
        {'L', 'e', 't', 't', 'e', 'r', 'G', 'o', 't', 'h', 'i', 'c', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "LetterGothicItalic", "LetterGothic-Italic",
                  "LetterGothic-Italic" },
        {'L', 'e', 't', 't', 'e', 'r', 'G', 'o', 't', 'h', 'i', 'c', ' ', ' ',
         'I', 't'},
    ...
    {
        { "Courier", "Courier", "NimbusMonoPS-Regular" },
        {'C', 'o', 'u', 'r', 'i', 'e', 'r', 'P', 'S', ' ', ' ', ' ', ' ', ' ',
         ' ', ' '},
    ...
    {
        { "Courier-Bold", "Courier-Bold", "NimbusMonoPS-Bold" },
        {'C', 'o', 'u', 'r', 'i', 'e', 'r', 'P', 'S', ' ', ' ', ' ', ' ', ' ',
         'B', 'd'},
    ...
    {
        { "Courier-Oblique", "Courier-Oblique", "NimbusMonoPS-Italic" },
        {'C', 'o', 'u', 'r', 'i', 'e', 'r', 'P', 'S', ' ', ' ', ' ', ' ', ' ',
         'O', 'b'},
...
const int pl_built_in_resident_font_table_count =
    countof(pl_built_in_resident_font_table) - 1;
